...
// function ViewerMode(props: Props): JSX.Element {
...
//     const snapshotInfo = await TimeMachineApi.getSnapshotInfo(snapshotId);
//     if (!snapshotInfo.ok) {
//       // TODO: error handling
//       return;
//     }
//     const snapshot = await TimeMachineApi.downloadSnapshot(snapshotInfo.ok.downloadToken);
